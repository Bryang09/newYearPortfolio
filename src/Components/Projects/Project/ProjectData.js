export const data = [
  ...
  },
  {
    ...
    desc:
      "React Application that uses the Petfinder API to search for local animals and shelters.",
    tech: ["React", "Scss", "Axios"],
    projectLink: "https://bryang09.github.io/new-shelter/#/",
    ghLink: "https://github.com/Bryang09/new-shelter",
    img: "shelter.svg",
    heroku: false
  }
];
